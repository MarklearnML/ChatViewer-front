        ...
        <span class="el-dropdown-link">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              ...
              <router-link to="/draft" class="non-underline" v-if="userStore.token !== ''">
                <el-dropdown-item>
                  <img :src="draftIcon" style="width:35px;height:35px;"/>
                  查看草稿
                </el-dropdown-item>
              </router-link>
            </el-dropdown-menu>
...
import draftIcon from '@/assets/icon/problem.gif'
